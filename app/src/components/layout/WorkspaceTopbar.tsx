    ...
    <header className="glass-panel fade-up px-5 py-4">
      <div className="relative space-y-4">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <div className="flex items-center gap-2 text-xs font-semibold uppercase text-sea-700">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="hidden items-center gap-2 rounded-lg border border-sea-200/70 bg-sea-50/80 px-4 py-3 text-sm font-semibold text-sea-800 md:flex">
              <Sparkles className="h-4 w-4" />
              AI workspace active
            </div>
            <div className="flex items-center gap-3 rounded-lg border border-slate-200/80 bg-white/[0.85] px-4 py-3 shadow-sm">
